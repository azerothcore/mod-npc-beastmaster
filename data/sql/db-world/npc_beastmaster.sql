...
-- This setup is safe for first-time use with AzerothCore:
-- - Vendor, Gossip, Stable, and Script support
-- - "Speak" icon shown
-- - Gossip handled by script, not DB
-- - Dummy gossip_menu entry to suppress DB warnings
...
-- GOSSIP MENU (dummy, not used by script, suppresses DB warnings)
